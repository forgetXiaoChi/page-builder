...
exports.DynamicRequestProcessor = exports.defaultDynamicPath = void 0;
const fs = require("fs");
const errors_1 = require("../errors");
const priority_1 = require("./priority");
const fs_1 = require("fs");
exports.defaultDynamicPath = "/dynamic";
...
class DynamicRequestProcessor {
    constructor() {
        ...
        this.directoryPath = exports.defaultDynamicPath;
        console.assert(exports.defaultDynamicPath.startsWith("/"));
