...
let PageDataController = class PageDataController {
    ...
    update(conn, { item }, appId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!appId)
                throw errors_1.errors.argumentNull("appId");
            let obj = { pageData: item.pageData, templateId: item.templateId };
            if (item.name) {
                obj.name = item.name;
            }
...
__decorate([
    maishu_node_mvc_1.action(),
    __param(0, decoders_1.connection), __param(1, maishu_node_mvc_1.routeData), __param(2, decoders_1.currentAppId)
